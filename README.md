# Polish Cybersecurity MCP

**Polish cybersecurity data for AI compliance tools.**

[![npm version](https://badge.fury.io/js/%40ansvar%2Fpolish-cybersecurity-mcp.svg)](https://www.npmjs.com/package/@ansvar/polish-cybersecurity-mcp)
[![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![CI](https://github.com/Ansvar-Systems/polish-cybersecurity-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/Ansvar-Systems/polish-cybersecurity-mcp/actions/workflows/ci.yml)
...
**Endpoint:** `https://mcp.ansvar.eu/polish-cybersecurity/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add polish-cybersecurity-mcp --transport http https://mcp.ansvar.eu/polish-cybersecurity/mcp` |
...
```json
{
  "mcpServers": {
    "polish-cybersecurity-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/polish-cybersecurity/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/polish-cybersecurity-mcp
```
...
```json
{
  "mcpServers": {
    "polish-cybersecurity-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/polish-cybersecurity-mcp"]
    }
  }
}
```
...
| Tool | Description |
|------|-------------|
| `pl_cyber_search_guidance` | Full-text search across CERT Polska / CSIRT NASK guidelines and technical reports. Covers cybersecurity guides, KSC (... |
| `pl_cyber_get_guidance` | Get a specific CERT Polska guidance document by reference (e.g., |
| `pl_cyber_search_advisories` | Search CERT Polska security advisories and alerts. Returns advisories with severity, affected products, and CVE refer... |
| `pl_cyber_get_advisory` | Get a specific CERT Polska security advisory by reference (e.g., |
| `pl_cyber_list_frameworks` | List all CERT Polska frameworks and guidance series covered in this MCP, including the KSC national cybersecurity fra... |
| `pl_cyber_about` | Return metadata about this MCP server: version, data source, coverage, and tool list. |
